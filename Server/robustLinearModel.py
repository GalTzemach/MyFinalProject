...
class robustLinearModel(object):
    ...
    def myRansac(self):
        ...
        lw = 2
        # Inlier points
        plt.scatter(X[inlier_mask], y[inlier_mask], color='yellowgreen', marker='.', label='Inliers', linewidth=4)
        # Outlier points
        plt.scatter(X[outlier_mask], y[outlier_mask], color='red', marker='.',label='Outliers', linewidth=4)
        # Line of linear
